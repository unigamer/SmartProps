...
String[] available_effects = {
  "solid", "flash", "fade", "meteor", "meteor_random", "throw_random", "throw_random_b", "random_colours", "random_fade",  "random_fade_b", "fade_impact", "sync_throw_random", "sync_random", "sync_random_fade", "two_state", "two_state_b", "two_state_random", "disco"
};
