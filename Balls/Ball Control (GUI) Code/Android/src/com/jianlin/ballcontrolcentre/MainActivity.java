...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab_p_test = (Button) findViewById(R.id.tab_p_test);
       ...
       // findViewById(R.id.tab_p_test).setOnClickListener(OnClickListener);

        /*
        tab_p_test.setOnClickListener(new View.OnClickListener() {
    ...
    final OnClickListener mybuttonlistener = new OnClickListener() {
